  ...
  return (
    <div className="bg-surface">
      <div className="container-page max-w-2xl py-16 sm:py-20">
        <h1 className="font-heading text-2xl font-extrabold text-ink sm:text-3xl">{t.footer.privacy}</h1>
        <p className="mt-4 text-sm leading-7 text-muted">{t.legalPages.privacyIntro}</p>
        <ol className="mt-6 flex flex-col gap-3">
          {t.legalPages.privacyBody.map((paragraph, index) => (
