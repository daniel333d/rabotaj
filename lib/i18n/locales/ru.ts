...
const ru: Dictionary = {
  ...
  hero: {
    ...
    subtitle:
      "Найди работу в Польше и по всей Европе. Создай один карьерный профиль, откликайся быстрее и отслеживай каждый этап отбора.",
  ...
  latestJobs: {
    ...
    intro: "Свежие вакансии от компаний, публикующих объявления в Польше и Европе.",
  ...
  verifiedEmployers: {
    ...
    title: "Компании со значком Verified Employer проходят проверку данных.",
    text: "Проверка охватывает регистрационные данные компании и то, как она публикует условия трудоустройства. Значок Verified Employer не является оценкой работодателя или гарантией трудоустройства.",
  ...
  remoteAbroad: {
    ...
    abroadText: "Вакансии от компаний, публикующих условия трудоустройства в Германии, Нидерландах и других странах ЕС, многие с проживанием.",
  ...
  jobsPage: {
    ...
    filterCity: "Город",
    filterWorkMode: "Модель работы",
    filterAccommodation: "Проживание",
    filterSalary: "Зарплата",
    filterSalaryAny: "любая",
    filterSalaryFrom: "от",
  ...
  dashboard: {
    ...
    demoView: "Демонстрационный режим"
  },
  auth: {
  ...
  legalPages: {
    aboutIntro: "Rabotaj.com — прототип платформы для поиска работы в Польше, Украине и Центрально-Восточной Европе.",
    aboutBody:
      "Мы создаём Rabotaj.com как площадку, где кандидаты могут найти прозрачные вакансии в Польше и Европе, а работодатели — найти кандидатов, готовых работать или переехать. Эта версия сайта — демонстрационный прототип: данные вакансий, компаний и аккаунтов являются примерными.",
    contactIntro: "Есть вопросы об этом прототипе? Напишите нам.",
    contactEmailLabel: "Email",
    contactNote: "Это демо-версия — сообщения из этой формы никуда не отправляются.",
    termsIntro: "Краткие условия использования демо-версии Rabotaj.com.",
    termsBody: [
      "Rabotaj.com в текущем виде — функциональный прототип, представленный в демонстрационных целях.",
      "Вакансии, профили компаний и учётные записи пользователей на сайте являются примерными данными и не представляют реальные предложения о работе.",
      "Использование форм (регистрация, отклик, добавление вакансии) не создаёт никаких юридических или финансовых обязательств."
    ],
    privacyIntro: "Краткая информация о данных в демо-версии Rabotaj.com.",
    privacyBody: [
      "В демо-версии данные, введённые в формах, могут храниться только локально в браузере (например, сохранённые вакансии) или, после настройки бэкенда, в базе данных, используемой для тестирования.",
      "Мы не передаём данные третьим лицам и не используем их в маркетинговых целях.",
      "Итоговая, продакшн-версия политики конфиденциальности будет опубликована вместе с полным запуском сервиса."
    ]
  }
};
