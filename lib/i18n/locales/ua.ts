...
const ua: Dictionary = {
  ...
  hero: {
    ...
    subtitle:
      "Знайди перевірену роботу в Польщі та по всій Європі. Створи один кар'єрний профіль, подавай заявки швидше та відстежуй кожен етап відбору.",
  ...
  latestJobs: {
    ...
    intro: "Щойно додані вакансії від перевірених роботодавців у Польщі та Європі.",
  ...
  verifiedEmployers: {
    ...
    title: "Ми перевіряємо роботодавців перед публікацією на Rabotaj",
    text: "Кожна компанія з відзнакою Verified Employer проходить перевірку реєстраційних даних та практик найму, тож ти можеш подавати заявки з більшою впевненістю.",
  ...
  remoteAbroad: {
    ...
    abroadText: "Легальні вакансії в Німеччині, Нідерландах та інших країнах ЄС, багато з проживанням.",
